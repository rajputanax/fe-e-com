  ...
  return (
    <div className='about-dukan-dar' id='about'>
        ...
        <div className="about-dukan-content">
            ...
            <p className='about-desc'>At Dukan Dar, we're passionate about empowering local businesses by providing them with the tools to thrive in the digital age .</p>
            <a href="#">More Here</a>
        </div>
    </div>
  )
