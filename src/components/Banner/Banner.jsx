        ...
        <div className="container">
            <div className="dukan-banner-inner">
                <div className="dukan-overview">
                      ...
                      <p className="summary">Empowering local businesses with seamless e-commerce solutions, Dukan Dar bridges the gap between traditional markets and the digital world.</p>
